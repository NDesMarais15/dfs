...
def write_aggregate_stats():
    with open('../Helper Data/Aggregate Stats.csv', 'w+', newline='') as aggregate_stats:
        ...
        for file_name in os.listdir('../Historical Data'):
            if not file_name.endswith('csv'):
                continue
            with open('Historical Data/' + file_name) as file:
...
def scatter():
    ...
    aggregate_stats = pd.read_csv('../Helper Data/Aggregate Stats.csv')
